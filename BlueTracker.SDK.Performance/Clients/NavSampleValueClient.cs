...
namespace BlueTracker.SDK.Performance.Clients
{
    ...
    public class NavSampleValueClient : ApiWrapper
    {
        ...
        {
            var reqString = $"/api/v1/ships/{imoNumber}/navSamples/{EncodeRouteValue(sourceName)}/{customId}";
        ...
        public DateLimitedSearchResult<NavSample> GetAllBySourceName(string sourceName, int imoNumber,
            DateTime start, DateTime end, int page = 0, int pageSize = 100)
        {
            var reqString = $"/api/v1/ships/{imoNumber}/navSamples/{EncodeRouteValue(sourceName)}?start={start:yyyy-MM-ddTHH:mm}&end={end:yyyy-MM-ddTHH:mm}&page={page}&pageSize={pageSize}";
        ...
        {
            return PostObject<int, List<NavSampleData>>(navSampleData, $"/api/v1/ships/{imoNumber}/navSamples/{EncodeRouteValue(sourceName)}");
        }
