...
namespace BlueTracker.SDK.Performance.Clients
{
    public class SeaCargoCharterClient : ApiWrapper
    {
        ...
        {
            return GetObject<List<VoyageWithCargoParcels>>($"/api/v1/seaCargoCharter/voyages?startDate={startDate:yyyy-MM-ddTHH:mm}&endDate={endDate:yyyy-MM-ddTHH:mm}&chartererId={Encode(chartererId)}&chartererName={Encode(chartererName)}");
        }
        ...
        {
            return GetObject<ChartererVoyageEmissionSplit>($"/api/v1/seaCargoCharter/voyages/{voyageId}/split?chartererId={Encode(chartererId)}&chartererName={Encode(chartererName)}");
        }
