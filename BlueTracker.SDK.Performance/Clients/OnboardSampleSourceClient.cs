...
namespace BlueTracker.SDK.Performance.Clients
{
    ...
    public class OnboardSampleSourceClient : ApiWrapper
    {
        ...
        {
            return GetObject<OnboardSampleSource>($"/api/v1/onboardSamples/sources/{Escape(sourceName)}");
        }
        ...
        {
            return PostEmpty<OnboardSampleSource>($"/api/v1/onboardSamples/sources?sourceName={Escape(sourceName)}");
        }
    }
}
